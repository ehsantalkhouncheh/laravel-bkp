...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                    href="<?php echo e(route('permission')); ?>">Permission</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                    href="<?php echo e(route('role')); ?>">Role</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                    href="<?php echo e(route('user')); ?>">User</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                    href="<?php echo e(route('layout')); ?>">Layout</a></div>
        </div>
